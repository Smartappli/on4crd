...
const expectedPublicActions = {
  ...
  articles: ['propose_category', 'propose_tag', 'toggle_favorite_article'],
  auction_view: [],
...
const expectedMemberActions = {
  ...
  members_library: ['delete_document', 'propose_category', 'propose_document', 'propose_subcategory', 'propose_tag', 'toggle_favorite_document', 'update_document'],
  my_requests: [],
...
const actionCoverage = {
  ...
  articles: ['tests/selenium/member-public-coverage.test.js', ['propose_category', 'propose_tag', 'toggle_favorite_article']],
  ...
  wiki_view: ['tests/selenium/member-pending-validation.test.js', ['update_page', 'delete_page']],
  ...
  members_library: ['tests/selenium/member-workflows.test.js', ['propose_document', 'update_document', 'delete_document']],
