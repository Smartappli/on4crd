...
const actionCoverage = {
  ...
  members_library: ['tests/selenium/member-workflows.test.js', ['propose_category', 'propose_subcategory', 'propose_tag', 'propose_document', 'toggle_favorite_document', 'update_document', 'delete_document']],
