...
final class MemberModulesFinalizationTest extends TestCase
{
    ...
    public function testWebothequeModuleKeepsCategorySelectsAndKeywordInputs(): void
    {
        ...
        self::assertStringContainsString('name="subsubcategory_ref"', $webotheque);
        self::assertStringContainsString('function webotheque_subcategory_ref(', $webotheque);
        self::assertStringContainsString('function webotheque_subsubcategory_ref(', $webotheque);
        self::assertStringContainsString('function webotheque_ensure_categories_table(', $webotheque);
        self::assertStringContainsString('function webotheque_ensure_subsubcategories_table(', $webotheque);
        ...
        self::assertStringContainsString('$visibleSubsubcategoriesByParent = webotheque_visible_subsubcategories_by_parent', $webotheque);
        ...
        self::assertStringContainsString("if (\$action === 'add_subsubcategory')", $webotheque);
        self::assertStringContainsString("if (\$action === 'delete_subsubcategory')", $webotheque);
        self::assertStringContainsString('UPDATE member_webotheque_links SET category = "general", subcategory = "", subsubcategory = "" WHERE category = ?', $webotheque);
    ...
    public function testMembersLibraryModuleKeepsDocumentTopicSelectAndKeywords(): void
    {
        ...
        self::assertStringContainsString("member_library_update_document_record(\$documentId, \$title, \$documentCategory, \$documentTags, \$description, \$sourceRef, \$documentSubcategory, \$documentSubsubcategory);", $library);
