...
final class FunctionHelpersExtendedTest extends TestCase
{
    ...
    public function testArticleSanitizeContentRepairsWordImportControlCharacterMojibake(): void
    {
        ...
        $mojibake = "Dossier n\xC3\x83\xC2\x82\xC3\x82\xC2\xB01\xC3\x82\xC2\xA0: Tenez \xC3\x83\xC2\x83\xC3\x82\xC2\xA0 l\xC3\x83\xC2\xA2\xC3\x82\xC2\x80\xC3\x82\xC2\x99\xC3\x83\xC2\x85\xC3\x82\xC2\x93il vos fusibles d\xC3\x83\xC2\xA2\xC3\x82\xC2\x80\xC3\x82\xC2\x99alimentation. Voici un indicateur que j\xC3\x83\xC2\xA2\xC3\x82\xC2\x80\xC3\x82\xC2\x99ai trouv\xC3\x83\xC2\x83\xC3\x82\xC2\xA9 au d\xC3\x83\xC2\x83\xC3\x82\xC2\xA9part.";
    ...
    public function testArticleSanitizeContentRepairsCurrentWordImportMojibakeVariant(): void
    {
        $text = html_entity_decode('Dossier n&deg;1 : Tenez &agrave; l&rsquo;&oelig;il vos fusibles d&rsquo;alimentation. Voici un indicateur que j&rsquo;ai trouv&eacute; au d&eacute;part.', ENT_QUOTES | ENT_HTML5, 'UTF-8');
        $mojibake = "Dossier n\xC3\x83\xC2\x82\xC3\x82\xC2\xB01\xC3\x83\xC2\x82\xC3\x82 : Tenez \xC3\x83\xC2\x83\xC3\x82  l\xC3\x83\xC2\xA2\xC3\x82\xC2\x80\xC3\x82\xC2\x99\xC3\x83\xC2\x85\xC3\x82\xC2\x93il vos fusibles d\xC3\x83\xC2\xA2\xC3\x82\xC2\x80\xC3\x82\xC2\x99alimentation. Voici un indicateur que j\xC3\x83\xC2\xA2\xC3\x82\xC2\x80\xC3\x82\xC2\x99ai trouv\xC3\x83\xC2\x83\xC3\x82\xC2\xA9 au d\xC3\x83\xC2\x83\xC3\x82\xC2\xA9part.";
...
<w:hdr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  <w:p><w:r><w:t>Entete importe</w:t></w:r></w:p>
</w:hdr>
XML;
        $footerXml = <<<'XML'
<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<w:ftr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  <w:p><w:r><w:t>Pied de page importe</w:t></w:r></w:p>
</w:ftr>
XML;
        ...
        file_put_contents($tmp, self::zipFixture([
            '[Content_Types].xml' => '<?xml version="1.0" encoding="UTF-8"?><Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types"><Default Extension="rels" ContentType="application/vnd.openxmlformats-package.relationships+xml"/><Default Extension="xml" ContentType="application/xml"/><Default Extension="png" ContentType="image/png"/><Default Extension="html" ContentType="text/html"/><Override PartName="/word/document.xml" ContentType="application/vnd.openxmlformats-officedocument.wordprocessingml.document.main+xml"/><Override PartName="/word/numbering.xml" ContentType="application/vnd.openxmlformats-officedocument.wordprocessingml.numbering+xml"/><Override PartName="/word/footnotes.xml" ContentType="application/vnd.openxmlformats-officedocument.wordprocessingml.footnotes+xml"/><Override PartName="/word/endnotes.xml" ContentType="application/vnd.openxmlformats-officedocument.wordprocessingml.endnotes+xml"/><Override PartName="/word/header1.xml" ContentType="application/vnd.openxmlformats-officedocument.wordprocessingml.header+xml"/><Override PartName="/word/footer1.xml" ContentType="application/vnd.openxmlformats-officedocument.wordprocessingml.footer+xml"/></Types>',
        ...
        try {
            ...
            self::assertStringContainsString('<p>Pied de page importe</p>', $html);
