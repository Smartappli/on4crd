    ...
    public function testProposalDialogTriggersKeepNativeFallbacks(): void
    {
        $contracts = [
            ...
            'app/member_webotheque.php' => [
                ...
                'data-webotheque-modal-open="webotheque-category-dialog"',
