    ...
    private function nonProposalActionContracts(): array
    {
        return [
            ...
            'admin member account actions' => [
                ...
                'selenium' => 'tests/selenium/admin-configuration-workflows.test.js',
                'selenium_snippets' => ['admin_members', 'create_member', 'memberForm', 'createdMemberForm', 'add_member_grade', 'save_member_payment', 'delete_member_grade', 'delete_member_payment'],
            ],
