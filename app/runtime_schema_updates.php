...
function apply_runtime_schema_updates(): void
{
    ...
    if (table_exists('albums')) {
        album_ensure_schema_columns_and_indexes(true);
    }
    ...
    seed_brocante_souper_crd_2026_event();
    seed_fete_aischois_2026_event();
