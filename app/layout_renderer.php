...
function module_css_assets_for_route(string $route): array
{
    ...
    $moduleByRoute = [
        ...
        'presentations' => 'members_library',
        'videos' => 'members_library',
        'pv' => 'members_library',
        'telechargements' => 'members_library',
        'admin_presentations' => 'admin_library',
        'admin_videos' => 'admin_library',
        'admin_pv' => 'admin_library',
        'admin_telechargements' => 'admin_library',
