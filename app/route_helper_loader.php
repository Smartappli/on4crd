...
function app_load_route_helpers(string $route): void
{
    $helperRoutes = [
        ...
        'member_module_documents.php' => ['my_requests', 'presentations', 'videos', 'pv', 'fichiers', 'telechargements', 'admin_presentations', 'admin_videos', 'admin_pv', 'admin_fichiers', 'admin_telechargements'],
