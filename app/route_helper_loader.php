...
function app_load_route_helpers(string $route): void
{
    $helperRoutes = [
        ...
        'notifications.php' => ['dashboard', 'notifications', 'articles', 'article', 'albums', 'album', 'classifieds', 'members_library', 'admin_articles', 'admin_albums', 'admin_classifieds', 'admin_library', 'admin_presentations', 'admin_videos', 'admin_pv', 'admin_telechargements', 'admin_news'],
        'article_import_helpers.php' => ['admin_articles', 'admin_library', 'admin_presentations', 'admin_videos', 'admin_pv', 'admin_telechargements'],
