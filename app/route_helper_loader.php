...
function app_load_route_helpers(string $route): void
{
    $helperRoutes = [
        ...
        'qsl_helpers.php' => ['qsl', 'qsl_preview', 'qsl_export', 'members_library', 'admin_library'],
        'member_library_helpers.php' => ['members_library', 'admin_library', 'admin_articles', 'chatbot', 'wiki', 'wiki_edit', 'wiki_propose', 'wiki_view', 'admin_wiki', 'member_library_preview'],
