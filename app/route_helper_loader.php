...
function app_load_route_helpers(string $route): void
{
    $helperRoutes = [
        ...
        'member_library_helpers.php' => ['members_library', 'admin_library', 'admin_articles', 'chatbot', 'wiki', 'wiki_edit', 'wiki_propose', 'wiki_view', 'admin_wiki'],
        ...
        'article_import_helpers.php' => ['presentations', 'videos', 'pv', 'fichiers', 'admin_articles', 'admin_library', 'admin_presentations', 'admin_videos', 'admin_pv', 'admin_fichiers'],
