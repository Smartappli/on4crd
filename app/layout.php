...
function localized_seo_defaults(string $route, string $locale, array $pageMeta, string $siteName): array
{
    ...
    $routeSeo = [
        ...
        'aiindexjson' => ['title' => 'AI index ON4CRD', 'description' => 'Index JSON public des contenus ON4CRD pour assistants et moteurs génératifs.', 'robots' => 'noindex,follow'],
        'album' => ['title' => 'Album photo ON4CRD', 'description' => 'Album photo public des activités, sorties et événements du Radio Club Durnal ON4CRD.'],
        'albums' => ['title' => 'Galerie photo ON4CRD', 'description' => 'Galerie des albums publics du Radio Club Durnal ON4CRD.'],
        'article' => ['title' => 'Article ON4CRD', 'description' => 'Article radioamateur publié par le Radio Club Durnal ON4CRD.'],
        'articles' => ['title' => 'Articles radioamateurs ON4CRD', 'description' => 'Articles, guides et retours d’expérience radioamateurs du Radio Club Durnal ON4CRD.'],
        'auction_bid' => ['title' => 'Offre d’enchère ON4CRD', 'description' => 'Endpoint de soumission d’offre pour les enchères ON4CRD.', 'robots' => 'noindex,nofollow'],
        'auction_view' => ['title' => 'Détail enchère ON4CRD', 'description' => 'Détail d’un lot ou d’une enchère radioamateur proposée par ON4CRD.'],
        'auctions' => ['title' => 'Enchères ON4CRD', 'description' => 'Enchères de matériel radioamateur du Radio Club Durnal ON4CRD.'],
        ...
        'change_password' => ['title' => 'Modification du mot de passe ON4CRD', 'description' => 'Modification sécurisée du mot de passe membre ON4CRD.', 'robots' => 'noindex,nofollow'],
        'classifieds' => ['title' => 'Petites annonces ON4CRD', 'description' => 'Petites annonces radioamateurs et matériel entre membres et visiteurs ON4CRD.'],
        ...
        'committee' => ['title' => 'Comité ON4CRD', 'description' => 'Présentation du comité et de l’organisation du Radio Club Durnal ON4CRD.'],
        ...
        'donation' => ['title' => 'Faire un don au Radio Club Durnal', 'description' => 'Page dédiée aux dons ponctuels pour soutenir les activités, le matériel et les projets radioamateurs ON4CRD.'],
        ...
        'events' => ['title' => 'Agenda ON4CRD', 'description' => 'Agenda des réunions, activités, sorties et événements radioamateurs du Radio Club Durnal.'],
        'events_feed' => ['title' => 'Flux calendrier ON4CRD', 'description' => 'Flux technique des événements ON4CRD pour FullCalendar et exports.', 'robots' => 'noindex,nofollow'],
        ...
        'home' => ['title' => 'Radio Club Durnal ON4CRD', 'description' => 'Portail du Radio Club Durnal ON4CRD : actualités, événements, outils et ressources radioamateurs.'],
        ...
        'logout' => ['title' => 'Déconnexion ON4CRD', 'description' => 'Déconnexion sécurisée de l’espace membre ON4CRD.', 'robots' => 'noindex,nofollow'],
        'members_library' => ['title' => 'Bibliothèque membres ON4CRD', 'description' => 'Bibliothèque documentaire réservée aux membres du Radio Club Durnal ON4CRD.', 'robots' => 'noindex,follow'],
        'webotheque' => ['title' => 'Webothèque membres ON4CRD', 'description' => 'Liens et ressources web réservés aux membres du Radio Club Durnal ON4CRD.', 'robots' => 'noindex,follow'],
        'presentations' => ['title' => 'Présentations membres ON4CRD', 'description' => 'Présentations et supports réservés aux membres du Radio Club Durnal ON4CRD.', 'robots' => 'noindex,follow'],
        'videos' => ['title' => 'Vidéos membres ON4CRD', 'description' => 'Vidéos et ressources audiovisuelles réservées aux membres du Radio Club Durnal ON4CRD.', 'robots' => 'noindex,follow'],
        'pv' => ['title' => 'Procès verbaux membres ON4CRD', 'description' => 'Procès verbaux et comptes rendus réservés aux membres du Radio Club Durnal ON4CRD.', 'robots' => 'noindex,follow'],
        'fichiers' => ['title' => 'Fichiers membres ON4CRD', 'description' => 'Fichiers et ressources à télécharger réservés aux membres du Radio Club Durnal ON4CRD.', 'robots' => 'noindex,follow'],
        'telechargements' => ['title' => 'Fichiers membres ON4CRD', 'description' => 'Fichiers et ressources à télécharger réservés aux membres du Radio Club Durnal ON4CRD.', 'robots' => 'noindex,follow'],
        ...
        'news' => ['title' => 'Actualités ON4CRD', 'description' => 'Dernières actualités, annonces et informations du Radio Club Durnal ON4CRD.'],
        ...
        'press' => ['title' => 'Presse ON4CRD', 'description' => 'Communiqués, publications et informations presse du Radio Club Durnal ON4CRD.'],
        'profile' => ['title' => 'Profil membre ON4CRD', 'description' => 'Profil personnel et informations de membre ON4CRD.', 'robots' => 'noindex,nofollow'],
        'qsl' => ['title' => 'QSL ON4CRD', 'description' => 'Gestion QSL réservée aux membres ON4CRD.', 'robots' => 'noindex,nofollow'],
        'qsl_export' => ['title' => 'Export QSL ON4CRD', 'description' => 'Export technique des données QSL ON4CRD.', 'robots' => 'noindex,nofollow'],
        'qsl_preview' => ['title' => 'Aperçu QSL ON4CRD', 'description' => 'Aperçu technique QSL ON4CRD.', 'robots' => 'noindex,nofollow'],
        ...
        'schools' => ['title' => 'Écoles et sensibilisation ON4CRD', 'description' => 'Actions pédagogiques, animations et sensibilisation radioamateur du Radio Club Durnal.'],
        'search' => ['title' => 'Recherche globale ON4CRD', 'description' => 'Recherche dans les contenus, actualités, articles, wiki et ressources ON4CRD.'],
        ...
        'wiki_edit' => ['title' => 'Édition wiki ON4CRD', 'description' => 'Interface d’édition du wiki ON4CRD.', 'robots' => 'noindex,nofollow'],
    ...
    foreach ([
        ...
        'admin_dashboard', 'admin_dinner_reservations', 'admin_editorial', 'admin_events', 'admin_events_feed', 'admin_library', 'admin_webotheque',
