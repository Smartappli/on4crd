...
function localized_seo_defaults(string $route, string $locale, array $pageMeta, string $siteName): array
{
    ...
    $routeSeo = [
        ...
        'medias' => ['title' => 'Medias membres ON4CRD', 'description' => 'Ressources medias reservees aux membres du Radio Club Durnal ON4CRD.', 'robots' => 'noindex,follow'],
        ...
        'telechargements' => ['title' => 'Telechargements membres ON4CRD', 'description' => 'Fichiers et ressources a telecharger reserves aux membres du Radio Club Durnal ON4CRD.', 'robots' => 'noindex,follow'],
