...
if (!function_exists('answer_question_from_knowledge')) {
    ...
    /** @return list<float> */
    function rag_embedding_vector_local(string $text, int $dim = 96): array
    {
    ...
    function rag_embedding_with_llphant(string $text): array
    {
        ...
        try {
            // Support optional integration when an app-level provider exposes this helper.
    ...
    function rag_embedding_vector(string $text, int $dim = 96): array
    {
        ...
        // Standardized external embedding provider: LLPhant.
        $providerVector = rag_embedding_with_llphant($trimmed);
        if ($providerVector !== []) {
            return $providerVector;
        }

        return rag_embedding_vector_local($trimmed, $dim);
    }
