...
function render_layout(string $content, string $title = ''): string
{
    ...
    return '<!doctype html><html lang="' . e($currentLocale) . '" data-theme="' . e($currentTheme) . '" style="--accent: ' . e($accentColor) . '; --accent-strong: ' . e($accentStrongColor) . ';"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>'
        ...
        . '<section><h3 class="footer-title">Radio Club Durnal</h3><p class="footer-copy">Adresse : Bocq Arena, Rue des Écoles, 5530 Purnode</p><p class="footer-copy">Éditeurs responsables: ON4BEN &amp; ON4DG.</p></section>'
        . '<section><h3 class="footer-title">Newsletter &amp; contact</h3><form class="footer-newsletter-form" method="get" action="' . e(route_url('newsletter')) . '"><label for="footer-newsletter-email" class="sr-only">Email newsletter</label><input id="footer-newsletter-email" type="email" name="email" placeholder="Votre email" required><button type="submit" class="button">S\'inscrire à la newsletter</button></form><form class="footer-contact-form" method="get" action="' . e(route_url('press')) . '"><label for="footer-contact-name" class="sr-only">Nom</label><input id="footer-contact-name" type="text" name="name" placeholder="Votre nom" required><label for="footer-contact-email" class="sr-only">Email</label><input id="footer-contact-email" type="email" name="email" placeholder="Votre email" required><label for="footer-contact-message" class="sr-only">Message</label><textarea id="footer-contact-message" name="message" placeholder="Votre message" rows="3" required></textarea><button type="submit" class="button secondary">Envoyer</button></form></section>'
        . '<section><h3 class="footer-title">Liens</h3><ul class="footer-nav"><li><a href="' . e(route_url('conditions_utilisation')) . '">Conditions générales d\'utilisation</a></li><li><a href="' . e(route_url('mentions_legales')) . '">Mentions légales</a></li><li><a href="' . e(route_url('reglement_interieur')) . '">Règlement d\'ordre intérieur</a></li><li><a href="' . e(route_url('membership')) . '">Faire un don</a></li><li><a href="' . e(route_url('sponsoring')) . '">Sponsoring</a></li></ul></section>'
