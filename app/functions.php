...
function render_layout(string $content, string $title = ''): string
{
    ...
    return '<!doctype html><html lang="' . e($currentLocale) . '" data-theme="' . e($currentTheme) . '" style="--accent: ' . e($accentColor) . '; --accent-strong: ' . e($accentStrongColor) . ';"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>'
        ...
        . '</div><div class="footer-meta"><span>© 2026 Radio Club Durnal (ON4CRD)</span><span><a href="https://www.facebook.com/groups/clubradiodurnal/" target="_blank" rel="noopener noreferrer" aria-label="Facebook - Club Radio Durnal" title="Facebook - Club Radio Durnal" style="display:inline-flex;align-items:center;gap:.35rem;"><svg aria-hidden="true" viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M22 12a10 10 0 1 0-11.56 9.87v-6.99H7.9V12h2.54V9.8c0-2.5 1.49-3.88 3.77-3.88 1.09 0 2.23.19 2.23.19v2.45h-1.26c-1.24 0-1.63.77-1.63 1.56V12h2.78l-.44 2.88h-2.34v6.99A10 10 0 0 0 22 12z"></path></svg><span class="sr-only">Facebook</span></a></span><span>Site réalisé par <a href="https://smartappli.eu">Smartappli ®</a></span></div></div></footer>'
