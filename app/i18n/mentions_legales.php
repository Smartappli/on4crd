...
$messages = [];
$messages['fr'] = require __DIR__ . '/mentions_legales/fr.php';
$messages['en'] = require __DIR__ . '/mentions_legales/en.php';
$messages['de'] = require __DIR__ . '/mentions_legales/de.php';
$messages['nl'] = require __DIR__ . '/mentions_legales/nl.php';
$messages['it'] = require __DIR__ . '/mentions_legales/it.php';
$messages['es'] = require __DIR__ . '/mentions_legales/es.php';
$messages['pt'] = require __DIR__ . '/mentions_legales/pt.php';
$messages['bg'] = require __DIR__ . '/mentions_legales/bg.php';
$messages['hr'] = require __DIR__ . '/mentions_legales/hr.php';
$messages['cs'] = require __DIR__ . '/mentions_legales/cs.php';
$messages['da'] = require __DIR__ . '/mentions_legales/da.php';
$messages['et'] = require __DIR__ . '/mentions_legales/et.php';
$messages['fi'] = require __DIR__ . '/mentions_legales/fi.php';
$messages['el'] = require __DIR__ . '/mentions_legales/el.php';
$messages['hu'] = require __DIR__ . '/mentions_legales/hu.php';
$messages['ga'] = require __DIR__ . '/mentions_legales/ga.php';
$messages['lv'] = require __DIR__ . '/mentions_legales/lv.php';
$messages['lt'] = require __DIR__ . '/mentions_legales/lt.php';
$messages['mt'] = require __DIR__ . '/mentions_legales/mt.php';
$messages['pl'] = require __DIR__ . '/mentions_legales/pl.php';
$messages['ro'] = require __DIR__ . '/mentions_legales/ro.php';
$messages['sk'] = require __DIR__ . '/mentions_legales/sk.php';
$messages['sl'] = require __DIR__ . '/mentions_legales/sl.php';
$messages['sv'] = require __DIR__ . '/mentions_legales/sv.php';
$messages['ar'] = require __DIR__ . '/mentions_legales/ar.php';
$messages['hi'] = require __DIR__ . '/mentions_legales/hi.php';
$messages['ja'] = require __DIR__ . '/mentions_legales/ja.php';
$messages['zh'] = require __DIR__ . '/mentions_legales/zh.php';
$messages['bn'] = require __DIR__ . '/mentions_legales/bn.php';
$messages['ru'] = require __DIR__ . '/mentions_legales/ru.php';
$messages['id'] = require __DIR__ . '/mentions_legales/id.php';
