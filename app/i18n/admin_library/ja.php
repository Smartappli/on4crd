...
return array (
  ...
  'subsubcategory_ph' => 'サブサブテーマ',
  'subsubcategories' => 'サブサブテーマ',
  'add_subsubcategory' => 'サブサブテーマを追加',
  'subsubcategory_code' => 'サブサブテーマコード',
  'subsubcategory_label' => 'サブサブテーマラベル',
  'ok_subsubcategory' => 'サブサブテーマを保存しました。',
  'ok_subsubcategory_deleted' => 'サブサブテーマを削除しました。ドキュメントは親トピックに残ります。',
