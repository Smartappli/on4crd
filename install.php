...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        seed_modules(); seed_dashboard_widgets(); seed_news_sections(); seed_brocante_crd_2026_news(); seed_brocante_souper_crd_2026_event(); seed_fete_aischois_2026_event(); seed_liberation_eghezee_2026_event(); seed_ad_placements(); seed_live_feeds();
