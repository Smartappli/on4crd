...
$i18n = [
    ...
    'es' => ['ok_saved' => 'Artículo guardado.', 'err_invalid_category' => 'Categoría no válida.', 'ok_category_updated' => 'Categoría actualizada.', 'err_delete_category' => 'No se puede eliminar esta categoría.', 'ok_category_deleted' => 'Categoría eliminada (artículos movidos a la categoría predeterminada).', 'edit' => 'Editar', 'create' => 'Crear', 'an_article' => 'un artículo', 'title' => 'Título', 'slug' => 'Slug', 'category' => 'Categoría', 'new_category' => 'Nueva categoría…', 'new_category_id' => 'Nueva categoría (identificador)', 'import_document' => 'Importar un documento (PDF, DOCX, TXT, MD, HTML)', 'excerpt' => 'Resumen', 'content_simple_html' => 'Contenido (HTML simple)', 'status' => 'Estado', 'draft' => 'Borrador', 'published' => 'Publicado', 'save' => 'Guardar', 'existing_articles' => 'Artículos existentes', 'category_label' => 'Categoría:', 'category_edit' => 'Editar categorías', 'code' => 'Código', 'label' => 'Etiqueta', 'rename_code' => 'Renombrar código', 'delete_to_other' => 'Eliminar (a categoría predeterminada)', 'no_articles' => 'No hay artículos.', 'custom_category_ph' => 'p. ej. propagacion-vhf', 'cat_antennes' => 'Antenas', 'cat_trafic' => 'Tráfico y DX', 'cat_numerique' => 'Modos digitales', 'cat_materiel' => 'Equipo y estación', 'cat_formation' => 'Formación', 'cat_autres' => 'Otros', 'layout' => 'Artículos', 'meta_desc' => 'Administración y publicación de artículos del sitio.'],
    'it' => ['ok_saved' => 'Articolo salvato.', 'err_invalid_category' => 'Categoria non valida.', 'ok_category_updated' => 'Categoria aggiornata.', 'err_delete_category' => 'Impossibile eliminare questa categoria.', 'ok_category_deleted' => 'Categoria eliminata (articoli spostati nella categoria predefinita).', 'edit' => 'Modifica', 'create' => 'Crea', 'an_article' => 'un articolo', 'title' => 'Titolo', 'slug' => 'Slug', 'category' => 'Categoria', 'new_category' => 'Nuova categoria…', 'new_category_id' => 'Nuova categoria (identificatore)', 'import_document' => 'Importa un documento (PDF, DOCX, TXT, MD, HTML)', 'excerpt' => 'Riepilogo', 'content_simple_html' => 'Contenuto (HTML semplice)', 'status' => 'Stato', 'draft' => 'Bozza', 'published' => 'Pubblicato', 'save' => 'Salva', 'existing_articles' => 'Articoli esistenti', 'category_label' => 'Categoria:', 'category_edit' => 'Modifica categorie', 'code' => 'Codice', 'label' => 'Etichetta', 'rename_code' => 'Rinomina codice', 'delete_to_other' => 'Elimina (nella categoria predefinita)', 'no_articles' => 'Nessun articolo.', 'custom_category_ph' => 'es. propagazione-vhf', 'cat_antennes' => 'Antenne', 'cat_trafic' => 'Traffico e DX', 'cat_numerique' => 'Modi digitali', 'cat_materiel' => 'Attrezzatura e stazione', 'cat_formation' => 'Formazione', 'cat_autres' => 'Altro', 'layout' => 'Articoli', 'meta_desc' => 'Amministrazione e pubblicazione degli articoli del sito.'],
