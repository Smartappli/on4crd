...
$i18n = [
    'fr' => ['event_saved' => 'Événement enregistré.', 'layout' => 'Administration agenda', 'title_required' => 'Titre obligatoire.', 'form_title' => 'un événement', 'edit' => 'Modifier', 'create' => 'Créer', 'title' => 'Titre', 'slug' => 'Slug', 'summary' => 'Résumé', 'description' => 'Description', 'start' => 'Début', 'end' => 'Fin', 'location' => 'Lieu', 'external_url' => 'URL externe', 'type' => 'Type', 'status' => 'Statut', 'type_club' => 'Club', 'type_contest' => 'Contest', 'draft' => 'Brouillon', 'published' => 'Publié', 'save' => 'Enregistrer', 'saved_events' => 'Événements enregistrés', 'no_event' => 'Aucun événement.', 'calendar_view' => 'Vue calendrier (FullCalendar)', 'calendar_help' => 'Cliquez sur un événement pour ouvrir son édition.', 'today' => 'Aujourd’hui', 'month' => 'Mois', 'week' => 'Semaine', 'list' => 'Liste'],
    'en' => ['event_saved' => 'Event saved.', 'layout' => 'Agenda administration', 'title_required' => 'Title is required.', 'form_title' => 'an event', 'edit' => 'Edit', 'create' => 'Create', 'title' => 'Title', 'slug' => 'Slug', 'summary' => 'Summary', 'description' => 'Description', 'start' => 'Start', 'end' => 'End', 'location' => 'Location', 'external_url' => 'External URL', 'type' => 'Type', 'status' => 'Status', 'type_club' => 'Club', 'type_contest' => 'Contest', 'draft' => 'Draft', 'published' => 'Published', 'save' => 'Save', 'saved_events' => 'Saved events', 'no_event' => 'No event.', 'calendar_view' => 'Calendar view (FullCalendar)', 'calendar_help' => 'Click an event to open its edition.', 'today' => 'Today', 'month' => 'Month', 'week' => 'Week', 'list' => 'List'],
    'de' => ['event_saved' => 'Ereignis gespeichert.', 'layout' => 'Agenda-Verwaltung', 'title_required' => 'Titel ist erforderlich.', 'form_title' => 'ein Ereignis', 'edit' => 'Bearbeiten', 'create' => 'Erstellen', 'title' => 'Titel', 'slug' => 'Slug', 'summary' => 'Zusammenfassung', 'description' => 'Beschreibung', 'start' => 'Beginn', 'end' => 'Ende', 'location' => 'Ort', 'external_url' => 'Externe URL', 'type' => 'Typ', 'status' => 'Status', 'type_club' => 'Club', 'type_contest' => 'Contest', 'draft' => 'Entwurf', 'published' => 'Veröffentlicht', 'save' => 'Speichern', 'saved_events' => 'Gespeicherte Ereignisse', 'no_event' => 'Keine Veranstaltung.', 'calendar_view' => 'Kalenderansicht (FullCalendar)', 'calendar_help' => 'Klicken Sie auf ein Ereignis, um die Bearbeitung zu öffnen.', 'today' => 'Heute', 'month' => 'Monat', 'week' => 'Woche', 'list' => 'Liste'],
    'nl' => ['event_saved' => 'Evenement opgeslagen.', 'layout' => 'Agenda-beheer', 'title_required' => 'Titel is verplicht.', 'form_title' => 'een evenement', 'edit' => 'Bewerken', 'create' => 'Aanmaken', 'title' => 'Titel', 'slug' => 'Slug', 'summary' => 'Samenvatting', 'description' => 'Beschrijving', 'start' => 'Start', 'end' => 'Einde', 'location' => 'Locatie', 'external_url' => 'Externe URL', 'type' => 'Type', 'status' => 'Status', 'type_club' => 'Club', 'type_contest' => 'Contest', 'draft' => 'Concept', 'published' => 'Gepubliceerd', 'save' => 'Opslaan', 'saved_events' => 'Opgeslagen evenementen', 'no_event' => 'Geen evenement.', 'calendar_view' => 'Kalenderweergave (FullCalendar)', 'calendar_help' => 'Klik op een evenement om de bewerking te openen.', 'today' => 'Vandaag', 'month' => 'Maand', 'week' => 'Week', 'list' => 'Lijst'],
];
