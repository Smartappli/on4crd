...
function admin_members_generate_mutual_form_response(int $memberId, string $year, array $labels): void
{
    ...
    echo '<h2>' . e((string) $labels['members']) . '</h2><div class="grid">';
    echo '<div class="field"><span class="label">' . e((string) $labels['th_last_name']) . '</span><span class="value">' . e((string) ($member['last_name'] ?? '')) . '</span></div>';
    echo '<div class="field"><span class="label">' . e((string) $labels['th_first_name']) . '</span><span class="value">' . e((string) ($member['first_name'] ?? '')) . '</span></div>';
    echo '<div class="field"><span class="label">' . e((string) $labels['th_callsign']) . '</span><span class="value">' . e((string) ($member['callsign'] ?? '')) . '</span></div>';
    echo '<div class="field"><span class="label">' . e((string) $labels['th_email']) . '</span><span class="value">' . e((string) ($member['email'] ?? '')) . '</span></div>';
    ...
    echo '</div><h2>' . e((string) $labels['payments_title']) . '</h2><div class="grid">';
    echo '<div class="field"><span class="label">' . e((string) $labels['payment_period_year']) . '</span><span class="value">' . e($year) . '</span></div>';
    echo '<div class="field"><span class="label">' . e((string) $labels['payment_status']) . '</span><span class="value">' . e((string) $labels['payment_status_paid']) . '</span></div>';
