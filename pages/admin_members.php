...
$i18n = [
    ...
    'nl' => ['member_updated' => 'Lid bijgewerkt.', 'title' => 'Ledenbeheer', 'layout' => 'Leden', 'meta_desc' => 'Beheer van ledenprofielen.', 'members' => 'Leden', 'th_callsign' => 'Callsign', 'th_name' => 'Naam', 'th_email' => 'E-mail', 'th_locator' => 'Locator', 'th_active' => 'Actief', 'th_committee' => 'Commissie', 'th_actions' => 'Acties', 'save' => 'Opslaan', 'err_callsign' => 'Callsign verplicht.', 'err_email' => 'Ongeldig e-mailadres.', 'err_locator' => 'Ongeldige locator.', 'search' => 'Lid zoeken', 'search_ph' => 'Callsign, naam, e-mail…', 'search_btn' => 'Zoeken'],
    'ar' => ['member_updated' => 'تم تحديث العضو.', 'title' => 'إدارة الأعضاء', 'layout' => 'الأعضاء', 'meta_desc' => 'إدارة ملفات الأعضاء.', 'members' => 'الأعضاء', 'th_callsign' => 'نداء', 'th_name' => 'الاسم', 'th_email' => 'البريد الإلكتروني', 'th_locator' => 'Locator', 'th_active' => 'نشط', 'th_committee' => 'اللجنة', 'th_actions' => 'الإجراءات', 'save' => 'حفظ', 'err_callsign' => 'النداء مطلوب.', 'err_email' => 'البريد الإلكتروني غير صالح.', 'err_locator' => 'Locator غير صالح.', 'search' => 'ابحث عن عضو', 'search_ph' => 'نداء، اسم، بريد…', 'search_btn' => 'بحث'],
    'hi' => ['member_updated' => 'सदस्य अपडेट किया गया।', 'title' => 'सदस्य प्रबंधन', 'layout' => 'सदस्य', 'meta_desc' => 'सदस्य प्रोफ़ाइल प्रबंधन।', 'members' => 'सदस्य', 'th_callsign' => 'कॉलसाइन', 'th_name' => 'नाम', 'th_email' => 'ईमेल', 'th_locator' => 'Locator', 'th_active' => 'सक्रिय', 'th_committee' => 'समिति', 'th_actions' => 'क्रियाएँ', 'save' => 'सहेजें', 'err_callsign' => 'कॉलसाइन आवश्यक है।', 'err_email' => 'अमान्य ईमेल।', 'err_locator' => 'अमान्य Locator।', 'search' => 'सदस्य खोजें', 'search_ph' => 'कॉलसाइन, नाम, ईमेल…', 'search_btn' => 'खोजें'],
    'ja' => ['member_updated' => 'メンバーを更新しました。', 'title' => 'メンバー管理', 'layout' => 'メンバー', 'meta_desc' => 'メンバープロフィールを管理します。', 'members' => 'メンバー', 'th_callsign' => 'コールサイン', 'th_name' => '名前', 'th_email' => 'メール', 'th_locator' => 'Locator', 'th_active' => '有効', 'th_committee' => '委員会', 'th_actions' => '操作', 'save' => '保存', 'err_callsign' => 'コールサインは必須です。', 'err_email' => '無効なメールアドレスです。', 'err_locator' => '無効な Locator です。', 'search' => 'メンバーを検索', 'search_ph' => 'コールサイン、名前、メール…', 'search_btn' => '検索'],
    'zh' => ['member_updated' => '成员已更新。', 'title' => '成员管理', 'layout' => '成员', 'meta_desc' => '管理成员资料。', 'members' => '成员', 'th_callsign' => '呼号', 'th_name' => '姓名', 'th_email' => '邮箱', 'th_locator' => 'Locator', 'th_active' => '启用', 'th_committee' => '委员会', 'th_actions' => '操作', 'save' => '保存', 'err_callsign' => '呼号为必填项。', 'err_email' => '邮箱无效。', 'err_locator' => 'Locator 无效。', 'search' => '搜索成员', 'search_ph' => '呼号、姓名、邮箱…', 'search_btn' => '搜索'],
    'bn' => ['member_updated' => 'সদস্য হালনাগাদ করা হয়েছে।', 'title' => 'সদস্য ব্যবস্থাপনা', 'layout' => 'সদস্য', 'meta_desc' => 'সদস্য প্রোফাইল ব্যবস্থাপনা।', 'members' => 'সদস্য', 'th_callsign' => 'কলসাইন', 'th_name' => 'নাম', 'th_email' => 'ইমেইল', 'th_locator' => 'Locator', 'th_active' => 'সক্রিয়', 'th_committee' => 'কমিটি', 'th_actions' => 'অ্যাকশন', 'save' => 'সংরক্ষণ', 'err_callsign' => 'কলসাইন আবশ্যক।', 'err_email' => 'অবৈধ ইমেইল।', 'err_locator' => 'অবৈধ Locator।', 'search' => 'সদস্য খুঁজুন', 'search_ph' => 'কলসাইন, নাম, ইমেইল…', 'search_btn' => 'খুঁজুন'],
    'ru' => ['member_updated' => 'Участник обновлён.', 'title' => 'Управление участниками', 'layout' => 'Участники', 'meta_desc' => 'Управление профилями участников.', 'members' => 'Участники', 'th_callsign' => 'Позывной', 'th_name' => 'Имя', 'th_email' => 'Email', 'th_locator' => 'Locator', 'th_active' => 'Активен', 'th_committee' => 'Комитет', 'th_actions' => 'Действия', 'save' => 'Сохранить', 'err_callsign' => 'Требуется позывной.', 'err_email' => 'Неверный email.', 'err_locator' => 'Неверный Locator.', 'search' => 'Найти участника', 'search_ph' => 'Позывной, имя, email…', 'search_btn' => 'Найти'],
    'id' => ['member_updated' => 'Anggota diperbarui.', 'title' => 'Manajemen anggota', 'layout' => 'Anggota', 'meta_desc' => 'Kelola profil anggota.', 'members' => 'Anggota', 'th_callsign' => 'Callsign', 'th_name' => 'Nama', 'th_email' => 'Email', 'th_locator' => 'Locator', 'th_active' => 'Aktif', 'th_committee' => 'Komite', 'th_actions' => 'Aksi', 'save' => 'Simpan', 'err_callsign' => 'Callsign wajib diisi.', 'err_email' => 'Email tidak valid.', 'err_locator' => 'Locator tidak valid.', 'search' => 'Cari anggota', 'search_ph' => 'Callsign, nama, email…', 'search_btn' => 'Cari'],
];
