...
$titles = ['fr'=>'Band planning ON2','en'=>'ON2 band plan','de'=>'ON2-Bandplan','nl'=>'ON2-bandplan'];
$intro = ['fr'=>'Référence multilingue ON2. Vérifier la version officielle IBPT/BIPT.','en'=>'ON2 multilingual reference. Verify official BIPT release.','de'=>'Mehrsprachige ON2-Referenz. Offizielle BIPT-Version prüfen.','nl'=>'Meertalige ON2-referentie. Controleer officiële BIPT-versie.'];
