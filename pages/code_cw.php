...
<section class="card">
  ...
  <h2 class="mt-4"><?= e(['fr'=>'Prosigns','en'=>'Prosigns','de'=>'Prosignale','nl'=>'Prosigns','es'=>'Prosignos','it'=>'Prosign','pt'=>'Prosignos','ar'=>'إشارات إجرائية','hi'=>'प्रोसाइन','ja'=>'プロサイン','zh'=>'程序信号','bn'=>'প্রোসাইন','ru'=>'Просигналы','id'=>'Prosign'][$locale] ?? 'Prosigns') ?></h2>
  <div class="table-wrap mt-2"><table><thead><tr><th>Prosign</th><th>Code</th><th><?= e(['fr'=>'Usage','en'=>'Usage','de'=>'Verwendung','nl'=>'Gebruik','es'=>'Uso','it'=>'Uso','pt'=>'Uso','ar'=>'الاستخدام','hi'=>'उपयोग','ja'=>'用途','zh'=>'用途','bn'=>'ব্যবহার','ru'=>'Применение','id'=>'Penggunaan'][$locale] ?? 'Usage') ?></th></tr></thead><tbody><tr><td>AR</td><td>.-.-.</td><td><?= e(['fr'=>'Fin de message','en'=>'End of message','de'=>'Ende der Nachricht','nl'=>'Einde bericht','es'=>'Fin del mensaje','it'=>'Fine del messaggio','pt'=>'Fim da mensagem','ar'=>'نهاية الرسالة','hi'=>'संदेश का अंत','ja'=>'メッセージ終了','zh'=>'报文结束','bn'=>'বার্তার শেষ','ru'=>'Конец сообщения','id'=>'Akhir pesan'][$locale] ?? 'Fin de message') ?></td></tr><tr><td>SK</td><td>...-.-</td><td><?= e(['fr'=>'Fin de contact','en'=>'End of contact','de'=>'Ende der Verbindung','nl'=>'Einde contact','es'=>'Fin del contacto','it'=>'Fine del contatto','pt'=>'Fim do contacto','ar'=>'نهاية الاتصال','hi'=>'संपर्क समाप्त','ja'=>'交信終了','zh'=>'联络结束','bn'=>'যোগাযোগের শেষ','ru'=>'Конец связи','id'=>'Akhir kontak'][$locale] ?? 'Fin de contact') ?></td></tr><tr><td>BT</td><td>-...-</td><td><?= e(['fr'=>'Séparateur','en'=>'Separator','de'=>'Trenner','nl'=>'Scheiding','es'=>'Separador','it'=>'Separatore','pt'=>'Separador','ar'=>'فاصل','hi'=>'विभाजक','ja'=>'区切り','zh'=>'分隔符','bn'=>'বিভাজক','ru'=>'Разделитель','id'=>'Pemisah'][$locale] ?? 'Séparateur') ?></td></tr><tr><td>AS</td><td>.-...</td><td><?= e(['fr'=>'Attendez','en'=>'Wait','de'=>'Warten','nl'=>'Wacht','es'=>'Espere','it'=>'Attendere','pt'=>'Aguarde','ar'=>'انتظر','hi'=>'प्रतीक्षा करें','ja'=>'待機','zh'=>'等待','bn'=>'অপেক্ষা করুন','ru'=>'Ожидайте','id'=>'Tunggu'][$locale] ?? 'Attendez') ?></td></tr></tbody></table></div>
</section>
