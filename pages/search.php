...
$i18n = [
    ...
    'ar' => ['title' => 'البحث', 'placeholder' => 'بحث شامل', 'submit' => 'بحث', 'count' => 'نتيجة', 'empty' => 'لا توجد نتائج لهذا البحث.', 'query_too_short' => 'يرجى إدخال حرفين على الأقل.', 'previous' => 'السابق', 'next' => 'التالي', 'meta_desc' => 'بحث ON4CRD الشامل في محتوى المقالات والويكي.'],
    'bn' => ['title' => 'অনুসন্ধান', 'placeholder' => 'সামগ্রিক অনুসন্ধান', 'submit' => 'খুঁজুন', 'count' => 'ফলাফল', 'empty' => 'এই অনুসন্ধানের জন্য কোনো ফলাফল পাওয়া যায়নি।', 'query_too_short' => 'কমপক্ষে ২টি অক্ষর লিখুন।', 'previous' => 'পূর্ববর্তী', 'next' => 'পরবর্তী', 'meta_desc' => 'আর্টিকেল ও উইকি বিষয়বস্তুতে ON4CRD-এর সামগ্রিক অনুসন্ধান।'],
    'hi' => ['title' => 'खोज', 'placeholder' => 'सामान्य खोज', 'submit' => 'खोजें', 'count' => 'परिणाम', 'empty' => 'इस खोज के लिए कोई परिणाम नहीं मिला।', 'query_too_short' => 'कृपया कम से कम 2 अक्षर दर्ज करें।', 'previous' => 'पिछला', 'next' => 'अगला', 'meta_desc' => 'लेख और विकी सामग्री में ON4CRD की वैश्विक खोज।'],
    'id' => ['title' => 'Pencarian', 'placeholder' => 'Pencarian global', 'submit' => 'Cari', 'count' => 'hasil', 'empty' => 'Tidak ada hasil untuk pencarian ini.', 'query_too_short' => 'Masukkan minimal 2 karakter.', 'previous' => 'Sebelumnya', 'next' => 'Berikutnya', 'meta_desc' => 'Pencarian global ON4CRD pada konten Artikel dan Wiki.'],
    'ja' => ['title' => '検索', 'placeholder' => '全体検索', 'submit' => '検索', 'count' => '件', 'empty' => 'この検索に一致する結果はありません。', 'query_too_short' => '2文字以上入力してください。', 'previous' => '前へ', 'next' => '次へ', 'meta_desc' => '記事とWikiコンテンツを対象にしたON4CRD全体検索。'],
    'ru' => ['title' => 'Поиск', 'placeholder' => 'Глобальный поиск', 'submit' => 'Искать', 'count' => 'результат(ов)', 'empty' => 'По этому запросу ничего не найдено.', 'query_too_short' => 'Введите не менее 2 символов.', 'previous' => 'Назад', 'next' => 'Вперёд', 'meta_desc' => 'Глобальный поиск ON4CRD по статьям и вики-контенту.'],
    'zh' => ['title' => '搜索', 'placeholder' => '全站搜索', 'submit' => '搜索', 'count' => '条结果', 'empty' => '未找到与此搜索匹配的结果。', 'query_too_short' => '请输入至少 2 个字符。', 'previous' => '上一页', 'next' => '下一页', 'meta_desc' => '在文章和 Wiki 内容中的 ON4CRD 全站搜索。'],
];
