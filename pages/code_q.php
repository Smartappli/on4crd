...
$titles = ['fr'=>'Code Q radioamateur (version exhaustive)','en'=>'Amateur radio Q-code (extended)','de'=>'Q-Code Funkamateur (erweitert)','nl'=>'Q-code radioamateur (uitgebreid)','es'=>'Código Q de radioaficionado (ampliado)','it'=>'Codice Q radioamatoriale (esteso)','pt'=>'Código Q de radioamador (alargado)'];
$title = $titles[$locale] ?? $titles['fr'];
$meaningLabel = ['fr'=>'Signification','en'=>'Meaning','de'=>'Bedeutung','nl'=>'Betekenis','es'=>'Significado','it'=>'Significato','pt'=>'Significado'][$locale] ?? 'Signification';
$qRows = [
...
<section class="card">
  <h1><?= e($title) ?></h1>
  <p class="help"><?= e(['fr'=>'Tableau étendu des Q-codes utilisés en radiocommunication (radioamateur et trafic général).','en'=>'Extended table of Q-codes used in radiocommunications (amateur and general traffic).','de'=>'Erweiterte Tabelle der Q-Codes im Funkverkehr (Amateurfunk und Allgemeinfunk).','nl'=>'Uitgebreide tabel van Q-codes gebruikt in radiocommunicatie (amateur en algemeen verkeer).','es'=>'Tabla ampliada de códigos Q usados en radiocomunicaciones (radioafición y tráfico general).','it'=>'Tabella estesa dei codici Q usati nelle radiocomunicazioni (radioamatori e traffico generale).','pt'=>'Tabela alargada de códigos Q usados em radiocomunicações (radioamador e tráfego geral).'][$locale] ?? 'Tableau étendu des Q-codes.') ?></p>
