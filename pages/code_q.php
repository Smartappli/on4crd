...
$title = (string) ($t['title'] ?? 'Amateur radio Q-code extended table');
$codeLabel = (string) ($t['code'] ?? 'Q-code');
$meaningLabel = (string) ($t['meaning'] ?? 'Meaning');
$qRows = [];
...
<section class="card">
  <h1><?= e($title) ?></h1>
  <p class="help"><?= e((string) ($t['intro'] ?? 'Extended table of Q-codes used in amateur radio and general radiocommunication traffic.')) ?></p>
