...
<section class="card" id="qsl-create" data-qsl-assistant data-qsl-panel="create">
    ...
    <div class="stack">
        ...
        <section class="stack" data-qsl-assistant-panel="adif">
            ...
            <form method="post" enctype="multipart/form-data" id="adif-dropzone-form" class="stack" data-adif-processing="<?= e($qt('adif_processing')) ?>" data-adif-import-error="<?= e($qt('adif_import_error')) ?>">
                <input type="hidden" name="_csrf" value="<?= e(csrf_token()) ?>">
