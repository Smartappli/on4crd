...
$i18n = [
    'fr' => ['err_question' => 'Veuillez saisir une question.', 'sidebar_help' => 'Posez une question technique, réglementaire ou club. Les réponses sont basées sur la base de connaissances interne.', 'clear' => 'Effacer la conversation', 'conversation_label' => 'Conversation avec Raymond', 'welcome' => 'Bonjour 👋 Je suis Raymond. Posez votre question, je vous réponds immédiatement.', 'source' => 'Source :', 'question_label' => 'Question', 'placeholder' => 'Ex. : Où trouver les procédures QSL ?', 'kbd_help' => 'Entrée pour envoyer · Maj+Entrée pour un saut de ligne', 'send' => 'Envoyer'],
    'en' => ['err_question' => 'Please enter a question.', 'sidebar_help' => 'Ask a technical, regulatory or club question. Answers are based on the internal knowledge base.', 'clear' => 'Clear conversation', 'conversation_label' => 'Conversation with Raymond', 'welcome' => 'Hello 👋 I am Raymond. Ask your question and I will answer right away.', 'source' => 'Source:', 'question_label' => 'Question', 'placeholder' => 'E.g.: Where can I find QSL procedures?', 'kbd_help' => 'Enter to send · Shift+Enter for a newline', 'send' => 'Send'],
    'de' => ['err_question' => 'Bitte geben Sie eine Frage ein.', 'sidebar_help' => 'Stellen Sie eine technische, regulatorische oder Clubfrage. Die Antworten basieren auf der internen Wissensdatenbank.', 'clear' => 'Konversation löschen', 'conversation_label' => 'Gespräch mit Raymond', 'welcome' => 'Hallo 👋 Ich bin Raymond. Stellen Sie Ihre Frage, ich antworte sofort.', 'source' => 'Quelle:', 'question_label' => 'Frage', 'placeholder' => 'Bsp.: Wo finde ich QSL-Verfahren?', 'kbd_help' => 'Enter zum Senden · Shift+Enter für Zeilenumbruch', 'send' => 'Senden'],
    'nl' => ['err_question' => 'Voer een vraag in.', 'sidebar_help' => 'Stel een technische, reglementaire of clubvraag. Antwoorden zijn gebaseerd op de interne kennisbank.', 'clear' => 'Gesprek wissen', 'conversation_label' => 'Gesprek met Raymond', 'welcome' => 'Hallo 👋 Ik ben Raymond. Stel je vraag, ik antwoord meteen.', 'source' => 'Bron:', 'question_label' => 'Vraag', 'placeholder' => 'Bijv.: Waar vind ik QSL-procedures?', 'kbd_help' => 'Enter om te verzenden · Shift+Enter voor een nieuwe regel', 'send' => 'Verzenden'],
];
