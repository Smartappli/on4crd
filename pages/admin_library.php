...
<div class="card">
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <input type="text" name="category" placeholder="<?= e((string) $t['category_ph']) ?>" value="general">
