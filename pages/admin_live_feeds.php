...
$i18n = [
    ...
    'es' => ['updated' => 'Feeds en vivo actualizados.', 'title' => 'Administración de feeds en vivo', 'intro' => 'Los widgets en tiempo real se limitan al panel de miembros.', 'active' => 'Activo', 'label' => 'Etiqueta', 'url' => 'URL', 'parser' => 'Parser', 'cache_ttl' => 'TTL caché', 'refresh' => 'Refresco navegador', 'notes' => 'Notas', 'save' => 'Guardar', 'layout' => 'Feeds en vivo', 'meta_desc' => 'Configuración de feeds en vivo del área miembros.'],
    'it' => ['updated' => 'Feed live aggiornati.', 'title' => 'Amministrazione feed live', 'intro' => 'I widget in tempo reale sono limitati alla dashboard membri.', 'active' => 'Attivo', 'label' => 'Etichetta', 'url' => 'URL', 'parser' => 'Parser', 'cache_ttl' => 'TTL cache', 'refresh' => 'Refresh browser', 'notes' => 'Note', 'save' => 'Salva', 'layout' => 'Feed live', 'meta_desc' => 'Configurazione dei feed live nell’area membri.'],
