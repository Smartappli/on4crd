...
$lines = [
    ...
    '- Meeting reference: Bocq Arena, Rue des Écoles, 5530 Purnode, Belgium',
    '- Coordinates: 50.3150, 4.9452',
    '- Service area: Durnal, Yvoir, Namur and French-speaking Belgium',
    ...
    '- Wiki: ' . route_url('wiki'),
    '- Albums: ' . route_url('albums'),
    '- Classifieds: ' . route_url('classifieds'),
    '- Auctions: ' . route_url('auctions'),
    '- Directory: ' . route_url('directory'),
    '- Tools: ' . route_url('tools'),
    '- Relay information: ' . route_url('relais'),
    '- Membership: ' . route_url('membership'),
    '- Sponsoring: ' . route_url('sponsoring'),
