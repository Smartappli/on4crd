...
$i18n = [
    'fr' => ['role_assigned' => 'Rôle attribué.', 'role_removed' => 'Rôle retiré.', 'title' => 'Rôles et permissions', 'th_permission' => 'Permission', 'th_label' => 'Libellé', 'assign_role' => 'Attribuer un rôle', 'member' => 'Membre', 'role' => 'Rôle', 'assign' => 'Attribuer', 'layout' => 'Rôles & permissions', 'meta_desc' => 'Gestion des rôles et permissions.', 'remove_role' => 'Retirer'],
    'en' => ['role_assigned' => 'Role assigned.', 'role_removed' => 'Role removed.', 'title' => 'Roles and permissions', 'th_permission' => 'Permission', 'th_label' => 'Label', 'assign_role' => 'Assign a role', 'member' => 'Member', 'role' => 'Role', 'assign' => 'Assign', 'layout' => 'Roles & permissions', 'meta_desc' => 'Manage roles and permissions.', 'remove_role' => 'Remove'],
    ...
    'es' => ['role_assigned' => 'Rol asignado.', 'role_removed' => 'Rol retirado.', 'title' => 'Roles y permisos', 'th_permission' => 'Permiso', 'th_label' => 'Etiqueta', 'assign_role' => 'Asignar rol', 'member' => 'Miembro', 'role' => 'Rol', 'assign' => 'Asignar', 'layout' => 'Roles y permisos', 'meta_desc' => 'Gestión de roles y permisos.', 'remove_role' => 'Retirar'],
    'it' => ['role_assigned' => 'Ruolo assegnato.', 'role_removed' => 'Ruolo rimosso.', 'title' => 'Ruoli e permessi', 'th_permission' => 'Permesso', 'th_label' => 'Etichetta', 'assign_role' => 'Assegna ruolo', 'member' => 'Membro', 'role' => 'Ruolo', 'assign' => 'Assegna', 'layout' => 'Ruoli e permessi', 'meta_desc' => 'Gestione ruoli e permessi.', 'remove_role' => 'Rimuovi'],
    'pt' => ['role_assigned' => 'Função atribuída.', 'role_removed' => 'Função removida.', 'title' => 'Funções e permissões', 'th_permission' => 'Permissão', 'th_label' => 'Rótulo', 'assign_role' => 'Atribuir função', 'member' => 'Membro', 'role' => 'Função', 'assign' => 'Atribuir', 'layout' => 'Funções e permissões', 'meta_desc' => 'Gestão de funções e permissões.', 'remove_role' => 'Remover'],
    'nl' => ['role_assigned' => 'Rol toegewezen.', 'role_removed' => 'Rol verwijderd.', 'title' => 'Rollen en rechten', 'th_permission' => 'Recht', 'th_label' => 'Label', 'assign_role' => 'Rol toewijzen', 'member' => 'Lid', 'role' => 'Rol', 'assign' => 'Toewijzen', 'layout' => 'Rollen & rechten', 'meta_desc' => 'Beheer van rollen en rechten.', 'remove_role' => 'Verwijderen'],
];
