            ...
            <?php foreach ($wikiSubcategoriesByCategory as $parentCode => $subcategories): ?>
                <?php foreach ($subcategories as $subcategoryInfo): ?>
                    ...
                    <form method="post" class="inline-form">
                        ...
                        <span class="pill taxonomy-pill-subcategory"><?= e((string) ($wikiCategories[(string) $parentCode] ?? $parentCode)) ?> / <?= e($subCode) ?> (<?= $subTotal ?>)</span>
            ...
            <?php foreach ($wikiSubsubcategoriesByParent as $parentRef => $subsubcategories): ?>
                ...
                <?php foreach ($subsubcategories as $subsubcategoryInfo): ?>
                    ...
                    <form method="post" class="inline-form">
                        ...
                        <span class="pill taxonomy-pill-subsubcategory"><?= e((string) ($wikiCategories[$parentCategory] ?? $parentCategory)) ?> / <?= e($parentSubcategoryLabel) ?> / <?= e($subsubCode) ?> (<?= $subsubTotal ?>)</span>
