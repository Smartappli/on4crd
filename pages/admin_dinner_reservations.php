...
$i18n = [
    ...
    'es' => ['err_invalid_reservation' => 'Indique un nombre y al menos una línea de reserva válida.', 'ok_saved' => 'Reserva guardada.', 'notes_placeholder' => 'Notas de alérgenos, opciones, etc.', 'layout' => 'Administración de cena anual', 'title' => 'Reservas de la cena anual', 'export_csv' => 'Exportar Excel (CSV)', 'reservation_name' => 'Nombre de la reserva', 'reservation_name_ph' => 'Ej.: Familia Dupont', 'add_line' => 'Añadir línea', 'total_to_pay' => 'Total a pagar:', 'notes' => 'Notas', 'save_reservation' => 'Guardar reserva', 'history' => 'Historial', 'no_history' => 'No hay reservas registradas.', 'total' => 'Total:', 'col_starter' => 'Entrante', 'col_meal' => 'Plato', 'col_dessert' => 'Postre', 'col_qty' => 'Cantidad', 'col_line_total' => 'Total línea', 'line_active' => 'Activo', 'line_remove' => 'Eliminar', 'yes' => 'Sí', 'no' => 'No', 'csv_reservation_id' => 'ID Reserva', 'csv_reserved_by' => 'Nombre', 'csv_created_at' => 'Fecha', 'csv_starter_enabled' => 'Entrante activo', 'csv_starter' => 'Entrante', 'csv_starter_price' => 'Precio entrante', 'csv_meal_enabled' => 'Plato activo', 'csv_meal' => 'Plato', 'csv_meal_price' => 'Precio plato', 'csv_dessert_enabled' => 'Postre activo', 'csv_dessert' => 'Postre', 'csv_dessert_price' => 'Precio postre', 'csv_quantity' => 'Cantidad', 'csv_line_total' => 'Total línea', 'csv_res_total' => 'Total reserva', 'meta_desc' => 'Gestión de reservas y exportación de la cena anual.'],
    'it' => ['err_invalid_reservation' => 'Indicare un nome e almeno una riga di prenotazione valida.', 'ok_saved' => 'Prenotazione salvata.', 'notes_placeholder' => 'Note allergeni, opzioni, ecc.', 'layout' => 'Amministrazione cena annuale', 'title' => 'Prenotazioni cena annuale', 'export_csv' => 'Esporta Excel (CSV)', 'reservation_name' => 'Nome prenotazione', 'reservation_name_ph' => 'Es.: Famiglia Dupont', 'add_line' => 'Aggiungi riga', 'total_to_pay' => 'Totale da pagare:', 'notes' => 'Note', 'save_reservation' => 'Salva prenotazione', 'history' => 'Storico', 'no_history' => 'Nessuna prenotazione registrata.', 'total' => 'Totale:', 'col_starter' => 'Antipasto', 'col_meal' => 'Piatto', 'col_dessert' => 'Dessert', 'col_qty' => 'Quantità', 'col_line_total' => 'Totale riga', 'line_active' => 'Attivo', 'line_remove' => 'Rimuovi', 'yes' => 'Sì', 'no' => 'No', 'csv_reservation_id' => 'ID Prenotazione', 'csv_reserved_by' => 'Nome', 'csv_created_at' => 'Data', 'csv_starter_enabled' => 'Antipasto attivo', 'csv_starter' => 'Antipasto', 'csv_starter_price' => 'Prezzo antipasto', 'csv_meal_enabled' => 'Piatto attivo', 'csv_meal' => 'Piatto', 'csv_meal_price' => 'Prezzo piatto', 'csv_dessert_enabled' => 'Dessert attivo', 'csv_dessert' => 'Dessert', 'csv_dessert_price' => 'Prezzo dessert', 'csv_quantity' => 'Quantità', 'csv_line_total' => 'Totale riga', 'csv_res_total' => 'Totale prenotazione', 'meta_desc' => 'Gestione prenotazioni ed esportazione della cena annuale.'],
    'pt' => ['err_invalid_reservation' => 'Indique um nome e pelo menos uma linha de reserva válida.', 'ok_saved' => 'Reserva guardada.', 'notes_placeholder' => 'Notas de alergénios, opções, etc.', 'layout' => 'Administração do jantar anual', 'title' => 'Reservas do jantar anual', 'export_csv' => 'Exportar Excel (CSV)', 'reservation_name' => 'Nome da reserva', 'reservation_name_ph' => 'Ex.: Família Dupont', 'add_line' => 'Adicionar linha', 'total_to_pay' => 'Total a pagar:', 'notes' => 'Notas', 'save_reservation' => 'Guardar reserva', 'history' => 'Histórico', 'no_history' => 'Não há reservas registadas.', 'total' => 'Total:', 'col_starter' => 'Entrada', 'col_meal' => 'Prato', 'col_dessert' => 'Sobremesa', 'col_qty' => 'Quantidade', 'col_line_total' => 'Total linha', 'line_active' => 'Ativo', 'line_remove' => 'Remover', 'yes' => 'Sim', 'no' => 'Não', 'csv_reservation_id' => 'ID Reserva', 'csv_reserved_by' => 'Nome', 'csv_created_at' => 'Data', 'csv_starter_enabled' => 'Entrada ativa', 'csv_starter' => 'Entrada', 'csv_starter_price' => 'Preço entrada', 'csv_meal_enabled' => 'Prato ativo', 'csv_meal' => 'Prato', 'csv_meal_price' => 'Preço prato', 'csv_dessert_enabled' => 'Sobremesa ativa', 'csv_dessert' => 'Sobremesa', 'csv_dessert_price' => 'Preço sobremesa', 'csv_quantity' => 'Quantidade', 'csv_line_total' => 'Total linha', 'csv_res_total' => 'Total reserva', 'meta_desc' => 'Gestão de reservas e exportação do jantar anual.'],
];
