<article class="card tool-panel" id="tool-bandwidth" data-tool-panel>
    ...
    <label><?= e((string) $t['mode_rate']) ?>
        <input type="text" inputmode="decimal" id="bandwidth-rate" min="0" step="1" value="1200">
    </label>
    <label><?= e((string) $t['rolloff_factor']) ?>
        <input type="text" inputmode="decimal" id="bandwidth-rolloff" min="0" step="0.01" value="0.35">
    </label>
