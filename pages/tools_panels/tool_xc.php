<article id="tool-xc" class="tool-panel card is-hidden" data-tool-panel>
    ...
    <div class="tool-grid-form">
        ...
        <input id="xc-freq" type="text" step="0.001" inputmode="decimal" placeholder="<?= e((string) ($t['freq_ph'] ?? 'Ex: 145.500')) ?>">

        <label for="xc-capacitance"><?= e((string) ($t['capacitance_pf'] ?? 'Capacitance (pF)')) ?></label>
        <input id="xc-capacitance" type="text" step="0.1" inputmode="decimal" placeholder="<?= e((string) ($t['capacitance_pf_ph'] ?? 'Ex: 100')) ?>">
