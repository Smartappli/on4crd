<article class="card tool-panel" id="tool-runtime" data-tool-panel>
    ...
    <label><?= e((string) ($t['capacity_mah'] ?? 'Battery capacity (mAh)')) ?>
        <input type="text" inputmode="decimal" id="runtime-capacity" min="0" step="1" value="2200">
    </label>
    <label><?= e((string) $t['current_ma']) ?>
        <input type="text" inputmode="decimal" id="runtime-current" min="0" step="1" value="500">
    </label>
