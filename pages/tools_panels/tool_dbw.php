<article id="tool-dbw" class="tool-panel card is-hidden" data-tool-panel>
    ...
    <div class="tool-grid-form">
        ...
        <input id="dbw-dbm" type="text" data-step="0.1" inputmode="decimal" placeholder="<?= e((string) ($t['dbm_ph'] ?? 'Ex: 40')) ?>">

        <label for="dbw-dbw-input"><?= e((string) ($t['dbw_label'] ?? 'dBW')) ?></label>
        <input id="dbw-dbw-input" type="text" data-step="0.1" inputmode="decimal" placeholder="<?= e((string) ($t['dbw_ph'] ?? 'Ex: 10')) ?>">
