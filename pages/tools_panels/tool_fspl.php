<article class="card tool-panel" id="tool-fspl" data-tool-panel>
    ...
    <label><?= e((string) $t['distance_km']) ?>
        <input type="text" inputmode="decimal" id="fspl-distance" min="0" step="0.01" value="10">
    </label>
    <label><?= e((string) $t['frequency_mhz']) ?>
        <input type="text" inputmode="decimal" id="fspl-frequency" min="0" step="0.001" value="145.5">
    </label>
