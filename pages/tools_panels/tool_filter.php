<article class="card tool-panel" id="tool-filter" data-tool-panel>
    ...
    <label><?= e((string) $t['cutoff_freq']) ?>
        <input type="text" inputmode="decimal" id="filter-freq" min="0" step="0.001" placeholder="<?= e((string) $t['freq_ph']) ?>">
    </label>
    <label><?= e((string) $t['impedance']) ?>
        <input type="text" inputmode="decimal" id="filter-impedance" min="1" step="0.1" value="50">
    </label>
