<article class="card tool-panel" id="tool-battery-current" data-tool-panel>
    ...
    <label><?= e((string) $t['battery_voltage_v']) ?>
        <input type="text" inputmode="decimal" id="battery-voltage" min="0.1" step="0.1" value="13.8">
    </label>
    <label><?= e((string) $t['load_power_w']) ?>
        <input type="text" inputmode="decimal" id="battery-load" min="0" step="0.1" value="50">
    </label>
