<article class="card tool-panel" id="tool-erp" data-tool-panel>
    ...
    <label><?= e((string) $t['tx_power_w']) ?>
        <input type="text" inputmode="decimal" id="erp-power" min="0" step="0.1" value="10">
    </label>
    <label><?= e((string) $t['feedline_loss_db']) ?>
        <input type="text" inputmode="decimal" id="erp-loss" min="0" step="0.1" value="1.5">
    </label>
    <label><?= e((string) $t['antenna_gain_dbd']) ?>
        <input type="text" inputmode="decimal" id="erp-gain" step="0.1" value="3">
    </label>
