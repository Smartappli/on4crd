...
$content = '<section class="grid gap-4 lg:grid-cols-[1.55fr_.95fr]">'
    ...
    . '<iframe class="h-56 w-full" title="Carte Google Map - Radio Club Durnal" loading="lazy" referrerpolicy="no-referrer-when-downgrade" src="https://www.google.com/maps?q=Bocq+Arena,+Rue+des+%C3%89coles,+5530+Purnode&output=embed"></iframe>'
    . '</div>'
    . '</article>'
    . '</div>'
    . '</aside>'
