...
$content = '<section class="grid gap-4 lg:grid-cols-[1.55fr_.95fr]">'
    ...
    . '<article><h3 class="text-lg font-bold text-slate-900">Adresse</h3><p class="mt-3 text-sm text-slate-700">Radio Club Durnal</p><p class="text-sm text-slate-700">Bocq Arena</p><p class="text-sm text-slate-700">Rue des Écoles</p><p class="text-sm text-slate-700">5530 Purnode</p><p class="mt-4 text-sm text-slate-700">Éditeurs responsables: ON4BEN : +32 496 260 865 &amp; ON4DG : +32 478 789 193.</p></article>'
    . '<article><h3 class="text-lg font-bold text-slate-900">Contact</h3><form class="mt-3 grid gap-2" method="post" action="' . e(route_url('footer_contact')) . '"><input type="hidden" name="_csrf" value="' . e(csrf_token()) . '"><input type="hidden" name="return_route" value="home"><label for="home-contact-name" class="sr-only">Nom</label><input id="home-contact-name" type="text" name="name" placeholder="Nom" required class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm"><label for="home-contact-email" class="sr-only">Email</label><input id="home-contact-email" type="email" name="email" placeholder="Email" required class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm"><label for="home-contact-message" class="sr-only">Message</label><textarea id="home-contact-message" name="message" placeholder="Message" rows="3" required class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm"></textarea><button type="submit" class="inline-flex items-center justify-center rounded-lg bg-slate-900 px-4 py-2 text-sm font-semibold text-white transition hover:bg-slate-800">Envoyer</button></form></article>'
    . '<article><h3 class="text-lg font-bold text-slate-900">Informations importantes</h3><ul class="mt-3 list-inside list-disc space-y-1 text-sm text-slate-700"><li><a class="hover:underline" href="' . e(route_url('conditions_utilisation')) . '">Conditions générales d\'utilisation</a></li><li><a class="hover:underline" href="' . e(route_url('mentions_legales')) . '">Mentions légales</a></li><li><a class="hover:underline" href="' . e(route_url('reglement_interieur')) . '">Règlement d\'ordre intérieur</a></li><li><a class="hover:underline" href="' . e(route_url('membership')) . '">Faire un don</a></li><li><a class="hover:underline" href="' . e(route_url('sponsoring')) . '">Sponsoring</a></li></ul><form class="mt-4 grid gap-2" method="get" action="' . e(route_url('newsletter')) . '"><label for="home-newsletter-email" class="sr-only">Email newsletter</label><input id="home-newsletter-email" type="email" name="email" placeholder="Email newsletter" required class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm"><button type="submit" class="inline-flex items-center justify-center rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-800 transition hover:bg-slate-50">S\'inscrire à la newsletter</button></form></article>'
    . '</div>'
    . '</section>';
