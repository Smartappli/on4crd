...
$content = '<section class="grid gap-4 lg:grid-cols-[1.55fr_.95fr]">'
    ...
    . '<article class="rounded-xl border border-slate-200 bg-slate-50 p-4">'
    . '<h3 class="text-sm font-semibold uppercase tracking-wide text-slate-500">Adresse du Radio Club</h3>'
    . '<p class="mt-2 text-sm text-slate-600">Bocq Arena, 17 rue des Écoles, 5530 Purnode</p>'
    . '<div class="mt-3 overflow-hidden rounded-lg border border-slate-200">'
    . '<iframe class="h-56 w-full" title="Carte Google Map - Radio Club Durnal" loading="lazy" referrerpolicy="no-referrer-when-downgrade" src="https://www.google.com/maps?q=Bocq+Arena,+17+rue+des+%C3%89coles,+5530+Purnode&output=embed"></iframe>'
    . '</div>'
    . '<a class="mt-3 inline-flex items-center rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm font-semibold text-slate-800 transition hover:bg-slate-50" href="https://www.google.com/maps/place/50%C2%B018%2754.1%22N+4%C2%B056%2742.8%22E/@50.3145995,4.9426197,472m/data=!3m1!1e3!4m7!1m2!2m1!1sBocq+Arena,+17+rue+des+%C3%89coles,+5530+Purnode!3m3!8m2!3d50.315017!4d4.945211?hl=fr&entry=ttu" target="_blank" rel="noopener noreferrer">Itinéraire Google Maps</a>'
    . '</article>'
    . '</div>'
    . '</aside>'
    . '</div>'
