...
$content = '<section class="grid gap-4 lg:grid-cols-[1.55fr_.95fr]">'
    ...
    . '<iframe class="h-56 w-full" title="Carte Google Map - Radio Club Durnal" loading="lazy" referrerpolicy="no-referrer-when-downgrade" src="https://www.google.com/maps?hl=fr&ll=50.3152092,4.942609&q=50.315017,4.945211&z=17&output=embed"></iframe>'
    . '</div>'
    . '</article>'
    . '</div>'
    . '</aside>'
