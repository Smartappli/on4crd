...
$content = '<section class="mb-4 grid gap-4 lg:grid-cols-2">'
    ...
    . '<div class="mt-2 flex flex-wrap items-center justify-between gap-3 border-t border-slate-200 pt-3">'
    . '<p class="text-xs font-medium text-slate-500" data-ham-weather-updated></p>'
