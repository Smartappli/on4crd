...
$content = '<section class="mb-4 grid gap-4 lg:grid-cols-2">'
    ...
    . '<span class="text-sm font-semibold text-slate-600" data-live-date data-timezone="UTC" aria-live="polite">' . e($homeTodayDate) . '</span>'
    ...
    . '<div class="mt-2 flex items-center justify-between gap-3">'
    . '<span class="text-sm font-semibold text-slate-600" data-live-date data-timezone="local" aria-live="polite">' . e($homeTodayDate) . '</span>'
