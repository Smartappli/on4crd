...
$content = '<section class="grid gap-4 lg:grid-cols-[1.55fr_.95fr]">'
    ...
    . '<article class="rounded-2xl border border-slate-200 bg-slate-50 p-4"><div class="flex items-start justify-between gap-3"><div><h3 class="text-lg font-semibold text-slate-900">Nous sommes affilié à l\'UBA</h3><p class="mt-2 text-sm text-slate-600">Le Radio Club Durnal est affilié à l\'Union Belge des Amateurs-Émetteurs.</p><a class="mt-3 inline-flex items-center rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm font-semibold text-slate-800 transition hover:bg-slate-50" href="https://uba.be" target="_blank" rel="noopener noreferrer">Visiter uba.be</a></div><img class="h-20 w-auto object-contain" src="' . e(asset_url($ubaLogoPath)) . '" alt="Logo UBA" loading="lazy" decoding="async"></div></article>'
