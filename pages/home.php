...
$content = '<section class="grid gap-4 lg:grid-cols-[1.55fr_.95fr]">'
    ...
    . '<article class="rounded-xl border border-slate-200 bg-slate-50 p-4"><strong class="block text-2xl font-extrabold text-slate-900">' . e((string) $moduleCount) . '</strong><span class="text-sm text-slate-600">modules actifs</span></article>'
    . '<article class="rounded-xl border border-slate-200 bg-slate-50 p-4"><strong class="block text-2xl font-extrabold text-slate-900">1 portail</strong><span class="text-sm text-slate-600">expérience homogène</span></article>'
    . '<article class="rounded-xl border border-slate-200 bg-slate-50 p-4"><strong class="block text-2xl font-extrabold text-slate-900">24/7</strong><span class="text-sm text-slate-600">accès web sécurisé</span></article>'
    . '</div>'
    . '<ul class="mt-4 space-y-2 text-sm text-slate-600">'
    . '<li>• Une page d’accueil orientée parcours utilisateur.</li>'
    . '<li>• Une mise en avant explicite de chaque module.</li>'
    . '<li>• Un ton institutionnel, moderne et professionnel.</li>'
    . '</ul>'
    . '</aside>'
    . '</section>'
