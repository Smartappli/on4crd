...
$content = '<section class="grid gap-4 lg:grid-cols-[1.55fr_.95fr]">'
    ...
    . '<iframe class="h-56 w-full" title="Carte Google Map - Radio Club Durnal" loading="lazy" referrerpolicy="no-referrer-when-downgrade" src="https://www.google.com/maps?hl=fr&q=50%C2%B018%2754.1%22N+4%C2%B056%2742.8%22E&z=18&output=embed"></iframe>'
    . '</div>'
    . '</article>'
    . '</div>'
    . '</aside>'
