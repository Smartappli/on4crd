...
$i18n = [
    ...
    'it' => ['module_off' => 'Modulo pubblicitario disattivato.', 'title' => 'Pubblicità', 'save_ok' => 'Pubblicità aggiornata.', 'create_ok' => 'Pubblicità creata.', 'status_ok' => 'Stato pubblicitario aggiornato.', 'ad_missing' => 'Pubblicità non trovata o non accessibile.', 'placement_required' => 'Il posizionamento è obbligatorio.', 'title_required' => 'Il titolo è obbligatorio.', 'invalid_format' => 'Formato pubblicitario non valido.', 'ad_not_found' => 'Pubblicità non trovata.', 'invalid_status' => 'Stato non valido.', 'edit_ad' => 'Modifica pubblicità', 'new_ad' => 'Invia pubblicità', 'module_help' => 'Questo modulo gestisce gli spazi sponsorizzati del club.'],
    'pt' => ['module_off' => 'Módulo publicitário desativado.', 'title' => 'Publicidade', 'save_ok' => 'Publicidade atualizada.', 'create_ok' => 'Publicidade criada.', 'status_ok' => 'Estado publicitário atualizado.', 'ad_missing' => 'Publicidade não encontrada ou inacessível.', 'placement_required' => 'A colocação é obrigatória.', 'title_required' => 'O título é obrigatório.', 'invalid_format' => 'Formato publicitário inválido.', 'ad_not_found' => 'Publicidade não encontrada.', 'invalid_status' => 'Estado inválido.', 'edit_ad' => 'Editar publicidade', 'new_ad' => 'Submeter publicidade', 'module_help' => 'Este módulo gere espaços patrocinados do clube.'],
