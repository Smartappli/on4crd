    ...
    <section class="card">
        ...
        <form method="post" class="stack">
            ...
            <div class="grid-2">
                ...
                <label>Stock (laisser vide pour illimité)<input type="text" name="stock_qty" value="<?= e(isset($editProduct['stock_qty']) && $editProduct['stock_qty'] !== null ? (string) $editProduct['stock_qty'] : '') ?>"></label>
            </div>
