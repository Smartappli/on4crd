...
$requiredLocales = ['fr', 'en', 'de', 'nl', 'es', 'it', 'pt'];
$homeRequiredLocales = ['fr', 'en', 'de', 'nl', 'es', 'it', 'pt', 'ar', 'bn', 'hi', 'id', 'ja', 'ru', 'zh'];
...
if ($issues === []) {
    echo "OK: all page-level i18n blocks include " . implode('/', $requiredLocales) . "\n";
    if ($warnings !== []) {
