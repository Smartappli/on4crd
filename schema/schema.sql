CREATE TABLE IF NOT EXISTS members (
    ...
    is_uba_member TINYINT(1) NOT NULL DEFAULT 0,
    ...
    visibility_last_name ENUM('public','members','private') NOT NULL DEFAULT 'private',
...
CREATE TABLE IF NOT EXISTS albums (
    ...
    facebook_post_id VARCHAR(80) DEFAULT NULL,
    instagram_media_id VARCHAR(80) DEFAULT NULL,
    social_published_at DATETIME DEFAULT NULL,
    social_publish_error TEXT DEFAULT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
